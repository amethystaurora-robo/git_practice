...
public class DogKinds {
    public static void main(String[] args) {
        String[] dogArray = {"bulldog", "pug", "pitbull", "pekingese", "bull terrier", "pomeranian", "poodle", "lab",
        "retriever", "australian shepherd", "german shepherd", "weimeraner", "whippet", "husky", "samoyed", "alaskan malamute",
        ...
        "miniature pinscher", "giant schnauzer", "ibizan hound", "airedale terrier", "komodor", "maltese", "dachsund",
        ...
        String filePath = "src/labs_examples/objects_classes_methods/labs/oop/DogKinds";
    }
}
